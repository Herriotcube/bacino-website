...
const MENU_DATA = {
  ...
  faqs: [
    ...
    { q: "Do you host private events or catering?", a: "We do. Bacino is available for private dining, celebrations and off-site catering. Email hello@bacino.sg with your date, group size and any menu preferences and we'll put together a proposal." },
    { q: "Do you have a corkage policy?", a: "We offer a delicately curated wine list with bottles priced very reasonably, so we don't operate a corkage policy at Bacino. Instead, we invite guests to explore our selection, which has been carefully chosen to complement the dining experience." },
