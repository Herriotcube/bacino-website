...
const MENU_DATA = {
  ...
  setlunch: [
    { key: "sl-2course", label: "2 Courses", note: "2-Courses · S$19 per person\nAdditional S$9 for your first glass of Prosecco, Malvasia Chardonnay, Sangiovese Merlot or Peroni Draft.\nAvailable Wednesday to Saturday, excl. public holidays and celebration days.", items: [
      { name: "Spaghetti Arrabbiata", price: "", desc: "Tomato sauce and chilli pepper.", heading: "Main Course" },
  ...
  faqs: [
    { q: "Do I need a reservation?", a: "We recommend booking ahead, especially for dinner and during weekends. You can quickly reserve through Google Reservations, or give us a call. Walk-ins are welcome whenever we have space.", reserveCta: true },
    ...
    { q: "Can I host a private event at Bacino?", a: "You can. Bacino is available for private dining and celebrations. Call us or email info@bacinobistro.com with your proposed date, group size and any menu preferences that you have and we'll be happy to put a proposal together for you." },
